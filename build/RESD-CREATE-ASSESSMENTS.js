...
exports.default = function (curRow) {
	...
	return {
		...
		FSSTDialog: function FSSTDialog(curCallback) {
			...
			sits_dialog(resdDialogs.DUEIN24HOURS.title, resdDialogs.DUEIN24HOURS.message, {
...
var _formatDate = require('../shared/js/formatDate');
...
function staffNamePrompt(row, callback) {
	var result = false;
	sits_dialog(resdDialogs.NAMEOFSTAFF.title, resdDialogs.NAMEOFSTAFF.message + ':\n\t\t<br/><br/>\n\t\t<input id="fsstInput" class="sv-form-control" type="text" />', {
...
function staffNamePromptSave(messager) {
...
function confirmCloseDialog() {
	sits_dialog(resdDialogs.QUIT24HRCHECK.title, resdDialogs.QUIT24HRCHECK.message, {
...
},{"../shared/js/formatDate":19,"./saveTask":12,"toastr":5}],7:[function(require,module,exports){
var css = {"styles":".requestRow td label{display:none}input[type=checkbox]{width:22px;height:22px;-webkit-border-radius:11px;-moz-border-radius:11px;border-radius:11px;border:1px solid #bbb}#accordion h3{color:#fff;background-color:#621b40;border-bottom-color:#fff}.progress{margin-bottom:0}@media (max-width:767px){.tablesaw-stack td .tablesaw-cell-content{max-width:50%;display:inline-block}.tablesaw-stack td .tablesaw-cell-label{word-break:break-word;width:50%}.save{margin-bottom:20px}.progress{margin-bottom:20px}}.save{min-height:34px}@media (min-width:1220px){.fixedWidth{min-width:350px;max-width:350px}}.requestTable{border:1px solid #ddd}@media (max-width:767px){.data-tablesaw-hide{display:none!important}.requestRow{background-color:#fff}.requestTable{border:none;border-collapse:separate;border-spacing:2px;background-color:#621b40}.requestTable thead{display:none}.sv-table-container{border:none}.taskType ::before{content:\"Task Type: \"}.selectedContainer{display:inline-block;width:20%}.fixedWidth{padding-bottom:20px}#ui-id-2>div>div>div>table>tbody>tr>td:nth-child(3)>div>div{text-align:center}.requestRow td label{display:inline-block}.dateCell,.titleCell{width:50%!important;float:left!important;clear:none!important;font-weight:700}}@media (max-width:400px){.dateCell,.titleCell{width:100%!important}}.no-gutter>[class*=col-]{padding-right:0;padding-left:0}body{overflow-y:scroll}.syncDocs{display:none}#accordion table{margin-bottom:0}.sv-panel{overflow:hidden}","stats":{"efficiency":0.247814910025707,"minifiedSize":1463,"originalSize":1945,"timeSpent":20},"errors":[],"inlinedStylesheets":[],"warnings":[]}; (require("browserify-css").createStyle(css, { "href": "src\\RESD-CREATE-ASSESSMENTS\\css\\styles.css" }, { "insertAt": "bottom" })); module.exports = css;
...
exports.rowSaveCallbackMessager = rowSaveCallbackMessager;
...
exports.default = {
	...
	rowSaveCallback: function rowSaveCallback(row) {
...
},{"./check24Hours":6,"./rowsSelected":11,"./saveTask.js":12,"./validation.js":14,"toastr":5}],9:[function(require,module,exports){
'use strict';
	...
	setEvidenceState: function setEvidenceState() {
		$('.evidence').each(function (i, e) {
			if ($('a[href*=\'SIW_FILE_LOAD\']:contains(\'' + $(e).data('file') + '\')').length > 0) {
				...
				if ((0, _getPlUploader2.default)().state !== 2) {
...
function uploadButtonToggle(row) {
	...
	if (selected && (saveBtn.hasClass('sv-btn-default') || saveBtn.hasClass('sv-btn-success')) && (0, _getPlUploader2.default)().state !== 2) {
...
},{"../shared/js/getPlUploader.js":20}],10:[function(require,module,exports){
'use strict';
...
},{"../shared/css/fancyLoadingButton.css":15,"../shared/css/styles.css":16,"../shared/css/toastr.css":18,"../shared/js/hiJackSaveAndExit":21,"../shared/js/tour":23,"./css/styles.css":7,"./eventHandlers.js":8,"./evidenceState.js":9,"./rowsSelected.js":11,"./uploaders.js":13}],11:[function(require,module,exports){
'use strict';
...
exports.urs = urs;
exports.updateRowsSelected = updateRowsSelected;
exports.validRowsSelected = validRowsSelected;
...
function updateRowsSelected(element, outputSelector) {
	var rows = validRowsSelected(element);
	$(outputSelector).html(rows);
	return rows;
}
function validRowsSelected(element) {
	var count = 0;
...
},{"./validation":14}],12:[function(require,module,exports){
'use strict';
...
function saveTask(toSave, callback) {
...
},{"../shared/js/submitFormAsync":22}],13:[function(require,module,exports){
'use strict';
...
},{"../shared/js/getPlUploader.js":20,"toastr":5}],14:[function(require,module,exports){
(function (global){
'use strict';
		...
		if ($('.requestRow').find('.selected:checked').length === 0) {
			...
			$('.requestRow').each(function (i, e) {
				if ($(e).find('.selected').first().prop('checked')) {
					...
					if ($(e).find('.save').hasClass('sv-btn-warning')) validationErrors.push('UNSAVED_TASK');
				}
			});
		}
...
},{"../css/tether-shepherd-arrows.css":17,"tether-shepherd":3}],24:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	validateRecordPicker: function validateInputs(recpicker) {
		$(recpicker).find('input[type="checkbox"]:checked').length === 0 ? $(recpicker).find('.sv-checkbox label').addClass('sv-mandatory') : $(recpicker).find('.sv-checkbox label').removeClass('sv-mandatory');
	}
};
