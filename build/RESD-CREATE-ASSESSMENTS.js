...
},{"../shared/js/formatDate":20,"./saveTask":12,"toastr":5}],7:[function(require,module,exports){
...
},{"../shared/js/getPlUploader.js":21}],10:[function(require,module,exports){
'use strict';
...
},{"../shared/css/fancyLoadingButton.css":15,"../shared/css/styles.css":16,"../shared/css/toastr.css":18,"../shared/js/hiJackSaveAndExit":22,"../shared/js/tour":24,"./css/styles.css":7,"./eventHandlers.js":8,"./evidenceState.js":9,"./rowsSelected.js":11,"./uploaders.js":13}],11:[function(require,module,exports){
'use strict';
...
},{"../shared/js/submitFormAsync":23}],13:[function(require,module,exports){
'use strict';
...
},{"../shared/js/getPlUploader.js":21,"toastr":5}],14:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../shared/js/validator":25,"toastr":5}],15:[function(require,module,exports){
...
var css = ".sv-form-control.sv-mandatory{color:#000}.sv-btn-danger{background-color:#e58681;border-color:#e06c66;color:#000}.sv-btn-danger:hover{background-color:#ea9e9a;color:#000}.sv-btn-success,.sv-btn-success:hover,.sv-btn-warning,.sv-btn-warning:hover{color:#000}.requestRow td:nth-child(1){word-break:break-word;-ms-word-break:break-word}.help-tour,.help-tour:active,.help-tour:focus,.help-tour:visited{text-decoration:none;color:#fff}.help-tour:hover{color:#eee}"; (require("browserify-css").createStyle(css, { "href": "src\\shared\\css\\styles.css" }, { "insertAt": "bottom" })); module.exports = css;
...
var css = ""; (require("browserify-css").createStyle(css, { "href": "src\\shared\\css\\validator.css" }, { "insertAt": "bottom" })); module.exports = css;
...
},{"../css/tether-shepherd-arrows.css":17,"tether-shepherd":3}],25:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	validateInputs: function validateInputs(inputs) {
		inputs.map(function (a) {
			return a.val().replace(/\s/g, '') == '' ? a.addClass('sv-mandatory') : a.removeClass('sv-mandatory');
		});
	},
