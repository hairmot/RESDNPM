...
var css = ".requestRow td label {\n  display: none;\n}\ninput[type=checkbox] {\n  width: 22px;\n  height: 22px;\n  -webkit-border-radius: 11px;\n  -moz-border-radius: 11px;\n  border-radius: 11px;\n  border: 1px solid #bbb;\n}\n#accordion h3 {\n  color: #fff;\n  background-color: #621b40;\n  border-bottom-color: white;\n}\n.progress {\n  margin-bottom: 0;\n}\n@media (max-width: 767px) {\n  .tablesaw-stack td .tablesaw-cell-content {\n    max-width: 50%;\n    display: inline-block;\n  }\n\n  .tablesaw-stack td .tablesaw-cell-label {\n    word-break: break-word;\n    width: 50%;\n  }\n\n  .save {\n    margin-bottom: 20px;\n  }\n\n  .progress {\n    margin-bottom: 20px;\n  }\n}\n.save {\n  min-height: 34px;\n}\n@media (min-width: 1220px) {\n  .fixedWidth {\n    min-width: 350px;\n    max-width: 350px;\n  }\n}\n.requestTable {\n  border: 1px solid #ddd;\n}\n@media (max-width: 767px) {\n  .data-tablesaw-hide {\n    display: none !important;\n  }\n\n  .requestRow {\n    background-color: white;\n  }\n\n  .requestTable {\n    border: none;\n    border-collapse: separate;\n    border-spacing: 2px;\n    background-color: #621b40;\n  }\n\n  .requestTable thead {\n    display: none;\n  }\n\n  .sv-table-container {\n    border: none;\n  }\n\n  .taskType ::before {\n    content: \"Task Type: \";\n  }\n\n  .selectedContainer {\n    display: inline-block;\n    width: 20%;\n  }\n\n  .fixedWidth {\n    padding-bottom: 20px;\n  }\n\n  #ui-id-2 > div > div > div > table > tbody > tr > td:nth-child(3) > div > div {\n    text-align: center;\n  }\n\n  .requestRow td label {\n    display: inline-block;\n  }\n\n  .dateCell,\n  .titleCell {\n    width: 50% !important;\n    float: left !important;\n    clear: none !important;\n    font-weight: 700;\n  }\n}\n@media (max-width: 400px) {\n  .dateCell,\n  .titleCell {\n    width: 100% !important;\n  }\n}\n.no-gutter > [class*='col-'] {\n  padding-right: 0;\n  padding-left: 0;\n}\nbody {\n  overflow-y: scroll;\n}\n.syncDocs {\n  display: none;\n}\n#accordion table {\n  margin-bottom: 0;\n}\n.sv-panel {\n  overflow: hidden;\n}\n"; (require("browserify-css").createStyle(css, { "href": "src\\RESD-CREATE-ASSESSMENTS\\css\\styles.css" }, { "insertAt": "bottom" })); module.exports = css;
...
var _validateNoEvidence = require('./validateNoEvidence');

var _validateNoEvidence2 = _interopRequireDefault(_validateNoEvidence);
...
exports.default = {
	...
	addValidationOnEvidenceReason: function addValidationOnEvidenceReason() {
		$('[data-noevidencereason]').on('change keyup', function () {
			(0, _validateNoEvidence2.default)();
		});
	},
...
},{"./check24Hours":6,"./rowsSelected":11,"./saveTask.js":12,"./validateNoEvidence":14,"./validation.js":15,"toastr":5}],9:[function(require,module,exports){
'use strict';
...
},{"../shared/css/fancyLoadingButton.css":16,"../shared/css/styles.css":17,"../shared/css/toastr.css":19,"../shared/js/hiJackSaveAndExit":22,"../shared/js/tour":24,"./css/styles.css":7,"./eventHandlers.js":8,"./evidenceState.js":9,"./rowsSelected.js":11,"./uploaders.js":13}],11:[function(require,module,exports){
'use strict';
...
},{"./validation":15}],12:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	validateEvidence: function validateEvidence(evidence) {
		...
		if (!result) {
			...
			return (0, _validateNoEvidence2.default)();
		} else {
			return result;
		}
	},
...
},{"../shared/js/validator":25,"./validateNoEvidence":14,"toastr":5}],16:[function(require,module,exports){
...
},{"../css/tether-shepherd-arrows.css":18,"tether-shepherd":3}],25:[function(require,module,exports){
'use strict';
