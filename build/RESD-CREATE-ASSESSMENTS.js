...
var css = ".sv-form-control.sv-mandatory{color:#000}.sv-btn-danger{background-color:#e58681;border-color:#e06c66;color:#000}.sv-btn-danger:hover{background-color:#ea9e9a;color:#000}.sv-btn-success,.sv-btn-success:hover,.sv-btn-warning,.sv-btn-warning:hover{color:#000}#page .requestRow td:nth-child(1){word-break:break-word;-ms-word-break:break-word}.help-tour,.help-tour:active,.help-tour:focus,.help-tour:visited{text-decoration:none;color:#fff}.help-tour:hover{color:#eee}"; (require("browserify-css").createStyle(css, { "href": "src\\shared\\css\\styles.css" }, { "insertAt": "bottom" })); module.exports = css;
